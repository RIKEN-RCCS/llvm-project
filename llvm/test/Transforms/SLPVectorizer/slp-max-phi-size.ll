...
; RUN: opt -vectorize-slp -passes=slp-vectorizer -S -slp-max-vf=1 < %s | FileCheck -check-prefix=MAX32 %s
; RUN: opt -vectorize-slp -passes=slp-vectorizer -S -slp-max-vf=8 < %s | FileCheck -check-prefix=MAX256 %s
; RUN: opt -vectorize-slp -passes=slp-vectorizer -S -slp-max-vf=32 < %s | FileCheck -check-prefix=MAX1024 %s
; RUN: opt -vectorize-slp -passes=slp-vectorizer -S < %s | FileCheck -check-prefix=MAX1024 %s
