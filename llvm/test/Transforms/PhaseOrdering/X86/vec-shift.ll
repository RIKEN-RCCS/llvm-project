...
; RUN: opt -vectorize-slp -passes="default<O3>" -S            < %s | FileCheck %s --check-prefix=SSE
; RUN: opt -vectorize-slp -passes="default<O3>" -S -mattr=avx < %s | FileCheck %s --check-prefix=AVX
