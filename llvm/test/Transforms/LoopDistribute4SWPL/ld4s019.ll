; RUN: opt -O1 -enable-loop-distribute4swpl -loopdist4swpl-enable-rtcheck -S -o /dev/null -pass-remarks-analysis=loop-distribute4swpl \
; RUN:   < %s |& FileCheck %s

; CHECK: loop not distributed: Can't find the array bounds.
