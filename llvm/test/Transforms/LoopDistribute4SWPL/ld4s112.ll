...
; CHECK: ![[LOOP1]] = distinct !{![[LOOP1]], [[MP:![0-9]+]], [[D4SWPL1:![0-9]+]], [[D4SWPLF:![0-9]+]], [[D4SWPLI:![0-9]+]], [[D4SWPLINST:![0-9]+]]}
...
; CHECK-NEXT: [[D4SWPLINST]] = !{!"llvm.loop.distribute4swpl.inst", i32 50}
...
!4 = distinct !{!4, !5, !7, !8, !9, !10}
!5 = !{!"llvm.loop.mustprogress"}
!6 = distinct !{!6, !5}
!7 = !{!"llvm.loop.distribute4swpl.enable", i1 true}
!8 = !{!"llvm.loop.distribute4swpl.freg", i32 16}
!9 = !{!"llvm.loop.distribute4swpl.ireg", i32 16}
!10 = !{!"llvm.loop.distribute4swpl.inst", i32 50}
