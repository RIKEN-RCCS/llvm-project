...
; CHECK:   br i1 %exitcond.not.ldist1, label %for.body.preheader, label %for.body.ldist1, !llvm.loop ![[LOOP1:.*]]
; CHECK:   br i1 %exitcond.not, label %for.cond.cleanup, label %for.body, !llvm.loop ![[LOOP2:.*]]
; CHECK: ![[LOOP1]] = distinct !{![[LOOP1]], [[MP:![0-9]+]], [[UR:![0-9]+]], [[D4SWPL1:![0-9]+]]}
; CHECK-NEXT: [[MP]] = !{!"llvm.loop.mustprogress"}
; CHECK-NEXT: [[UR]] = !{!"llvm.loop.unroll.disable"}
; CHECK-NEXT: [[D4SWPL1]] = !{!"llvm.loop.distributed4swpl", i32 2, i32 1}
; CHECK-NEXT: ![[LOOP2]] = distinct !{![[LOOP2]], [[MP]], [[UR]], [[D4SWPL2:![0-9]+]]}
; CHECK-NEXT: [[D4SWPL2]] = !{!"llvm.loop.distributed4swpl", i32 2, i32 2}
...
!8 = !{!"Simple C/C++ TBAA"}
!9 = distinct !{!9, !10, !11, !12, !13, !14, !15}
!10 = !{!"llvm.loop.mustprogress"}
!11 = !{!"llvm.loop.unroll.disable"}
!12 = !{!"llvm.loop.distribute4swpl.enable", i1 true}
!13 = !{!"llvm.loop.distribute4swpl.freg", i32 16}
!14 = !{!"llvm.loop.distribute4swpl.ireg", i32 16}
!15 = !{!"llvm.loop.distribute4swpl.inst", i32 50}
