; RUN: opt -O1 -S -mcpu=a64fx -pass-remarks=loop-distribute4swpl -pass-remarks-missed=loop-distribute4swpl -pass-remarks-analysis=loop-distribute4swpl -distribute4swpl-limit-freg=1 -distribute4swpl-limit-ireg=30 -o /dev/null < %s |& FileCheck %s
...
!50 = !{!"llvm.loop.distribute4swpl.freg", i32 30}
!51 = !{!"llvm.loop.distribute4swpl.ireg", i32 999}
