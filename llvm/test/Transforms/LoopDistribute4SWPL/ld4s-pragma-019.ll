; RUN: opt -S -O1 -pass-remarks-analysis=loop-distribute4swpl -pass-remarks=loop-dist -distribute4swpl-limit-freg=30 -distribute4swpl-limit-ireg=30 < %s |& FileCheck %s
; CHECK: distributed loop: 1 of 3 ireg=3, freg=4, numInst=13
; CHECK-NEXT: distributed loop: 2 of 3 ireg=3, freg=4, numInst=13
; CHECK-NEXT: distributed loop: 3 of 3 ireg=3, freg=5, numInst=16
...
!8 = !{!"llvm.loop.distribute4swpl.enable", i1 true}
!9 = !{!"llvm.loop.distribute4swpl.inst", i32 20}
