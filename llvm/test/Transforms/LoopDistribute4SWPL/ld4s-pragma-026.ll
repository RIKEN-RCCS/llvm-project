; RUN: opt -O1 -S -mcpu=a64fx -pass-remarks=loop-distribute4swpl -pass-remarks-missed=loop-distribute4swpl -pass-remarks-analysis=loop-distribute4swpl -distribute4swpl-limit-freg=30 -distribute4swpl-limit-ireg=1 -o /dev/null < %s |& FileCheck %s
...
for.end:                                          ; preds = %for.cond
  %30 = load float, ptr %z, align 4, !dbg !52
  ret float %30, !dbg !53
}
...
!47 = distinct !{!47, !19, !45, !48, !49, !50, !51, !54}
!48 = !{!"llvm.loop.mustprogress"}
!49 = !{!"llvm.loop.distribute4swpl.enable", i1 true}
!50 = !{!"llvm.loop.distribute4swpl.freg", i32 999}
!51 = !{!"llvm.loop.distribute4swpl.ireg", i32 30}
!52 = !DILocation(line: 18, column: 10, scope: !9)
!53 = !DILocation(line: 18, column: 3, scope: !9)
!54 = !{!"llvm.loop.distribute4swpl.inst", i32 20}
