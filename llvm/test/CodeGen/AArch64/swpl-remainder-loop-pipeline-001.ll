...
; CHECK-NOT: remark: swpl-remainder-loop-pipeline-001.cpp:13:5: software pipelining

; ModuleID = './swpl-remainder-loop-pipeline-001.cpp'
source_filename = "./swpl-remainder-loop-pipeline-001.cpp"
...
define dso_local void @_Z28pipeline_initiation_intervalv() local_unnamed_addr #0 !dbg !8 {
entry:
...
for.end:                                          ; preds = %for.body
  %7 = load i32, ptr %z, align 4, !dbg !32, !tbaa !16
  %call = tail call noundef i32 (ptr, ...) @_Z6printfPKcz(ptr noundef nonnull @.str, i32 noundef %7), !dbg !33
  call void @llvm.lifetime.end.p0(i64 3996, ptr nonnull %z) #3, !dbg !34
  call void @llvm.lifetime.end.p0(i64 3996, ptr nonnull %y) #3, !dbg !34
  call void @llvm.lifetime.end.p0(i64 3996, ptr nonnull %x) #3, !dbg !34
  ret void, !dbg !34
}
...
declare !dbg !35 dso_local noundef i32 @_Z6printfPKcz(ptr noundef, ...) local_unnamed_addr #2
...
!1 = !DIFile(filename: "swpl-remainder-loop-pipeline-001.cpp", directory: "/home/xxxx", checksumkind: CSK_MD5, checksum: "80c60d4342d68c8b02d6fa23142438a7")
...
!9 = !DIFile(filename: "./swpl-remainder-loop-pipeline-001.cpp", directory: "/home/xxxx", checksumkind: CSK_MD5, checksum: "80c60d4342d68c8b02d6fa23142438a7")
...
!31 = distinct !{!31, !13, !25, !26, !27, !28}
!32 = !DILocation(line: 17, column: 11, scope: !8)
!33 = !DILocation(line: 18, column: 2, scope: !8)
!34 = !DILocation(line: 19, column: 1, scope: !8)
!35 = !DISubprogram(name: "printf", scope: !9, file: !9, line: 6, type: !10, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !11)
