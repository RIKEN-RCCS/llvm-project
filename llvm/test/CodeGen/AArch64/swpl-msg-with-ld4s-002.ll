...
for.body.ldist2:                                  ; preds = %for.body.ldist1, %for.body.ldist2
  ...
  %arrayidx10.ldist2 = getelementptr inbounds float, ptr %D, i64 %indvars.iv.ldist2, !dbg !31
  %4 = load float, ptr %arrayidx10.ldist2, align 4, !dbg !31, !tbaa !16
  %arrayidx12.ldist2 = getelementptr inbounds float, ptr %E, i64 %indvars.iv.ldist2, !dbg !32
  %5 = load float, ptr %arrayidx12.ldist2, align 4, !dbg !32, !tbaa !16
  %arrayidx14.ldist2 = getelementptr inbounds float, ptr %D1, i64 %indvars.iv.ldist2, !dbg !33
  %6 = load float, ptr %arrayidx14.ldist2, align 4, !dbg !33, !tbaa !16
  %7 = tail call float @llvm.fmuladd.f32(float %4, float %5, float %6), !dbg !34
  %arrayidx16.ldist2 = getelementptr inbounds float, ptr %C, i64 %indvars.iv.ldist2, !dbg !35
  store float %7, ptr %arrayidx16.ldist2, align 4, !dbg !36, !tbaa !16
  %exitcond.not.ldist2 = icmp eq i64 %indvars.iv.next.ldist2, %0, !dbg !13
  br i1 %exitcond.not.ldist2, label %for.body, label %for.body.ldist2, !dbg !14, !llvm.loop !37
...
for.body:                                         ; preds = %for.body.ldist2, %for.body
  ...
  %8 = trunc i64 %indvars.iv to i32, !dbg !39
  %9 = add i32 %8, %n, !dbg !39
  %conv = sitofp i32 %9 to float, !dbg !39
  %add8 = fadd float %z.032, %conv, !dbg !40
  %exitcond.not = icmp eq i64 %indvars.iv.next, %0, !dbg !13
  br i1 %exitcond.not, label %for.end, label %for.body, !dbg !14, !llvm.loop !41

for.end:                                          ; preds = %for.body, %entry
  %z.0.lcssa = phi float [ 0.000000e+00, %entry ], [ %add8, %for.body ], !dbg !43
  ret float %z.0.lcssa, !dbg !44
}
...
!12 = !{}
!13 = !DILocation(line: 9, column: 17, scope: !9)
!14 = !DILocation(line: 9, column: 3, scope: !9)
!15 = !DILocation(line: 10, column: 23, scope: !9)
!16 = !{!17, !17, i64 0}
!17 = !{!"float", !18, i64 0}
!18 = !{!"omnipotent char", !19, i64 0}
!19 = !{!"Simple C/C++ TBAA"}
!20 = !DILocation(line: 10, column: 30, scope: !9)
!21 = !DILocation(line: 10, column: 28, scope: !9)
!22 = !DILocation(line: 10, column: 9, scope: !9)
!23 = !DILocation(line: 10, column: 5, scope: !9)
!24 = !DILocation(line: 10, column: 14, scope: !9)
!25 = distinct !{!25, !14, !26, !27, !28, !29, !30}
!26 = !DILocation(line: 14, column: 3, scope: !9)
!27 = !{!"llvm.loop.mustprogress"}
!28 = !{!"llvm.loop.unroll.disable"}
!29 = !{!"llvm.loop.pipeline.initiationinterval", i32 39}
!30 = !{!"llvm.loop.distributed4swpl", i32 3, i32 2}
!31 = !DILocation(line: 12, column: 12, scope: !9)
...
!36 = !DILocation(line: 12, column: 10, scope: !9)
!37 = distinct !{!37, !14, !26, !27, !28, !29, !38}
!38 = !{!"llvm.loop.distributed4swpl", i32 3, i32 1}
!39 = !DILocation(line: 11, column: 10, scope: !9)
!40 = !DILocation(line: 11, column: 7, scope: !9)
!41 = distinct !{!41, !14, !26, !27, !28, !29, !42}
!42 = !{!"llvm.loop.distributed4swpl", i32 3, i32 3}
!43 = !DILocation(line: 0, scope: !9)
!44 = !DILocation(line: 15, column: 3, scope: !9)
