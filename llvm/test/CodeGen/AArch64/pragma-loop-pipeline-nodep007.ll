...
; CHECK-NOT: remark: ./pragma-loop-pipeline-nodep012-1.cpp:25:5: Since the pragma pipline_nodep was specified, it was assumed that there is no dependency between memory access instructions in the loop.
; CHECK-NOT: remark: ./pragma-loop-pipeline-nodep012-1.cpp:25:5: software pipelining (IPC: 2.00, ITR: 5, MVE: 3, II: 3, Stage: 3, (VReg Fp: 1/32, Int: 17/29, Pred: 1/8)), SRA(PReg Fp: 0/32, Int: 14/29, Pred: 0/8) 

; ModuleID = './pragma-loop-pipeline-nodep012-1.cpp'
source_filename = "./pragma-loop-pipeline-nodep012-1.cpp"
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, 1000, !dbg !30
  br i1 %exitcond.not, label %for.end, label %for.body, !dbg !12, !llvm.loop !31

for.end:                                          ; preds = %for.body, %vec.epilog.middle.block
  %50 = load i32, ptr @z, align 4, !dbg !32, !tbaa !15
  %call = tail call noundef i32 (ptr, ...) @_Z6printfPKcz(ptr noundef nonnull @.str, i32 noundef %50), !dbg !33
  ret void, !dbg !34
}

declare !dbg !35 dso_local noundef i32 @_Z6printfPKcz(ptr noundef, ...) local_unnamed_addr #1
...
!1 = !DIFile(filename: "pragma-loop-pipeline-nodep012-1.cpp", directory: "/home/xxxx", checksumkind: CSK_MD5, checksum: "993e8c0924617a390dcdfd7332d351df")
...
!9 = !DIFile(filename: "./pragma-loop-pipeline-nodep012-1.cpp", directory: "/home/xxxx", checksumkind: CSK_MD5, checksum: "993e8c0924617a390dcdfd7332d351df")
!10 = !DISubroutineType(types: !11)
!11 = !{}
!12 = !DILocation(line: 25, column: 5, scope: !8)
!13 = !DILocation(line: 25, column: 25, scope: !8)
!14 = !DILocation(line: 27, column: 16, scope: !8)
!15 = !{!16, !16, i64 0}
!16 = !{!"int", !17, i64 0}
!17 = !{!"omnipotent char", !18, i64 0}
!18 = !{!"Simple C++ TBAA"}
!19 = !DILocation(line: 27, column: 23, scope: !8)
!20 = !DILocation(line: 27, column: 21, scope: !8)
!21 = !DILocation(line: 27, column: 9, scope: !8)
!22 = !DILocation(line: 27, column: 14, scope: !8)
!23 = distinct !{!23, !12, !24, !25, !26, !27, !28}
!24 = !DILocation(line: 28, column: 5, scope: !8)
!25 = !{!"llvm.loop.mustprogress"}
!26 = !{!"llvm.loop.pipeline.nodep"}
!27 = !{!"llvm.loop.isvectorized", i32 1}
!28 = !{!"llvm.loop.unroll.runtime.disable"}
!29 = distinct !{!29, !12, !24, !25, !26, !27, !28}
!30 = !DILocation(line: 25, column: 19, scope: !8)
!31 = distinct !{!31, !12, !24, !25, !26, !28, !27}
!32 = !DILocation(line: 29, column: 11, scope: !8)
!33 = !DILocation(line: 30, column: 2, scope: !8)
!34 = !DILocation(line: 31, column: 1, scope: !8)
!35 = !DISubprogram(name: "printf", scope: !9, file: !9, line: 18, type: !10, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
