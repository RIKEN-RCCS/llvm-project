...
; CHECK: remark: ./pragma-loop-pipeline-nodep010.cpp:26:5: Since the pragma pipline_nodep was specified, it was assumed that there is no dependency between memory access instructions in the loop.
; CHECK: remark: ./pragma-loop-pipeline-nodep010.cpp:26:5: software pipelining (IPC: 2.00, ITR: 5, MVE: 3, II: 3, Stage: 3, (VReg Fp: 1/32, Int: 17/29, Pred: 1/8)), SRA(PReg Fp: 0/32, Int: 14/29, Pred: 0/8) 

; ModuleID = './pragma-loop-pipeline-nodep010.cpp'
source_filename = "./pragma-loop-pipeline-nodep010.cpp"
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %47, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !dbg !14, !llvm.loop !31
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, 1000, !dbg !33
  br i1 %exitcond.not, label %for.end, label %for.body, !dbg !13, !llvm.loop !34

for.end:                                          ; preds = %for.body, %vec.epilog.middle.block
  %50 = load i32, ptr %z, align 4, !dbg !35, !tbaa !16
  %call = tail call noundef i32 (ptr, ...) @_Z6printfPKcz(ptr noundef nonnull @.str, i32 noundef %50), !dbg !36
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %z) #4, !dbg !37
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %y) #4, !dbg !37
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %x) #4, !dbg !37
  ret void, !dbg !37
}
...
declare !dbg !38 dso_local noundef i32 @_Z6printfPKcz(ptr noundef, ...) local_unnamed_addr #2
...
!1 = !DIFile(filename: "pragma-loop-pipeline-nodep010.cpp", directory: "/home/xxxx", checksumkind: CSK_MD5, checksum: "d7abd93a6b24913c30c3e39a7c338173")
...
!9 = !DIFile(filename: "./pragma-loop-pipeline-nodep010.cpp", directory: "/home/xxxx", checksumkind: CSK_MD5, checksum: "d7abd93a6b24913c30c3e39a7c338173")
!10 = !DISubroutineType(types: !11)
!11 = !{}
!12 = !DILocation(line: 22, column: 5, scope: !8)
!13 = !DILocation(line: 26, column: 5, scope: !8)
!14 = !DILocation(line: 26, column: 25, scope: !8)
!15 = !DILocation(line: 28, column: 16, scope: !8)
!16 = !{!17, !17, i64 0}
!17 = !{!"int", !18, i64 0}
!18 = !{!"omnipotent char", !19, i64 0}
!19 = !{!"Simple C++ TBAA"}
!20 = !DILocation(line: 28, column: 23, scope: !8)
!21 = !DILocation(line: 28, column: 21, scope: !8)
!22 = !DILocation(line: 28, column: 9, scope: !8)
!23 = !DILocation(line: 28, column: 14, scope: !8)
!24 = distinct !{!24, !13, !25, !26, !27, !28, !29, !30}
!25 = !DILocation(line: 29, column: 5, scope: !8)
!26 = !{!"llvm.loop.mustprogress"}
!27 = !{!"llvm.loop.pipeline.enable"}
!28 = !{!"llvm.loop.pipeline.nodep"}
!29 = !{!"llvm.loop.isvectorized", i32 1}
!30 = !{!"llvm.loop.unroll.runtime.disable"}
!31 = distinct !{!31, !13, !25, !26, !27, !28, !29, !30, !32}
!32 = !{!"llvm.remainder.pipeline.disable"}
!33 = !DILocation(line: 26, column: 19, scope: !8)
!34 = distinct !{!34, !13, !25, !26, !27, !28, !30, !32, !29}
!35 = !DILocation(line: 30, column: 11, scope: !8)
!36 = !DILocation(line: 31, column: 2, scope: !8)
!37 = !DILocation(line: 32, column: 1, scope: !8)
!38 = !DISubprogram(name: "printf", scope: !9, file: !9, line: 18, type: !10, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
