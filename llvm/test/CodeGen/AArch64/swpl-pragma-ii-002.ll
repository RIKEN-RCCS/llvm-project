; RUN: llc < %s -O1 -mcpu=a64fx -fswp -swpl-disable-reg-alloc -swpl-debug -swpl-minii=8 -o /dev/null 2>&1 | FileCheck %s
;CHECK:Iterative Modulo Scheduling. ResMII 3. NumOfBodyInsts 9. Budget 450. II 5. Minimum II = 5.
