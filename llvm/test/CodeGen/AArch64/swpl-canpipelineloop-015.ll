; RUN: llc < %s -O1 -mcpu=a64fx  -ffj-swp  -swpl-debug  --pass-remarks-filter=aarch64-swp  -debug-hardwareloops  -debug-aarch64tti  --pass-remarks-filter=.*  --pass-remarks-output=-  -o /dev/null 2>&1 | FileCheck %s
