; RUN: llc < %s -mcpu=a64fx -O0 -fswp --pass-remarks-missed=aarch64-swpipeliner --pass-remarks=aarch64-swpipeliner --pass-remarks-output=- -debug-aarch64tti -o /dev/null 2>&1 | FileCheck --allow-empty %s
