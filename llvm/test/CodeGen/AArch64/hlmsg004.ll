; RUN: llc -O1 -mcpu=a64fx -pass-remarks-missed=hardware < %s -o /dev/null |& FileCheck %s
; CHECK: remark: target.c:9:3: hardware-loop not created
; ModuleID = 'target.ll'
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %3 = getelementptr inbounds [1000 x float], ptr @aa1, i64 0, i64 %indvars.iv, !dbg !15
  %4 = load float, ptr %3, align 4, !dbg !15
  %5 = getelementptr inbounds [1000 x float], ptr @cc1, i64 0, i64 %indvars.iv, !dbg !16
  %6 = load float, ptr %5, align 4, !dbg !16
  %7 = getelementptr inbounds [1000 x float], ptr @bb1, i64 0, i64 %indvars.iv, !dbg !17
  %8 = load float, ptr %7, align 4, !dbg !17
  %9 = tail call float @llvm.fmuladd.f32(float %6, float %8, float %4), !dbg !18
  %10 = getelementptr inbounds [1000 x float], ptr @dd1_org, i64 0, i64 %indvars.iv, !dbg !19
  store float %9, ptr %10, align 4, !dbg !20
  %11 = getelementptr inbounds [1000 x float], ptr @aa2, i64 0, i64 %indvars.iv, !dbg !21
  %12 = load float, ptr %11, align 4, !dbg !21
  %13 = getelementptr inbounds [1000 x float], ptr @cc2, i64 0, i64 %indvars.iv, !dbg !22
  %14 = load float, ptr %13, align 4, !dbg !22
  %15 = getelementptr inbounds [1000 x float], ptr @bb2, i64 0, i64 %indvars.iv, !dbg !23
  %16 = load float, ptr %15, align 4, !dbg !23
  %17 = tail call float @llvm.fmuladd.f32(float %14, float %16, float %12), !dbg !24
  %18 = getelementptr inbounds [1000 x float], ptr @dd2_org, i64 0, i64 %indvars.iv, !dbg !25
  store float %17, ptr %18, align 4, !dbg !26
  %19 = getelementptr inbounds [1000 x float], ptr @aa3, i64 0, i64 %indvars.iv, !dbg !27
  %20 = load float, ptr %19, align 4, !dbg !27
  %21 = getelementptr inbounds [1000 x float], ptr @cc3, i64 0, i64 %indvars.iv, !dbg !28
  %22 = load float, ptr %21, align 4, !dbg !28
  %23 = fadd float %20, %22, !dbg !29
  %24 = getelementptr inbounds [1000 x float], ptr @bb3, i64 0, i64 %indvars.iv, !dbg !30
  %25 = load float, ptr %24, align 4, !dbg !30
  %26 = fadd float %23, %25, !dbg !31
  %27 = fmul float %20, %22, !dbg !32
  %28 = tail call float @llvm.fmuladd.f32(float %27, float %25, float %26), !dbg !33
  %29 = getelementptr inbounds [1000 x float], ptr @dd3_org, i64 0, i64 %indvars.iv, !dbg !34
  store float %28, ptr %29, align 4, !dbg !35
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !36
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count, !dbg !13
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph, !dbg !14, !llvm.loop !37
...
!22 = !DILocation(line: 12, column: 27, scope: !10)
!23 = !DILocation(line: 12, column: 36, scope: !10)
!24 = !DILocation(line: 12, column: 25, scope: !10)
!25 = !DILocation(line: 12, column: 5, scope: !10)
!26 = !DILocation(line: 12, column: 16, scope: !10)
!27 = !DILocation(line: 13, column: 15, scope: !10)
!28 = !DILocation(line: 13, column: 24, scope: !10)
!29 = !DILocation(line: 13, column: 22, scope: !10)
!30 = !DILocation(line: 13, column: 33, scope: !10)
!31 = !DILocation(line: 13, column: 31, scope: !10)
!32 = !DILocation(line: 14, column: 25, scope: !10)
!33 = !DILocation(line: 14, column: 43, scope: !10)
!34 = !DILocation(line: 14, column: 5, scope: !10)
!35 = !DILocation(line: 14, column: 16, scope: !10)
!36 = !DILocation(line: 9, column: 27, scope: !10)
!37 = distinct !{!37, !14, !38, !39}
!38 = !DILocation(line: 15, column: 3, scope: !10)
!39 = !{!"llvm.loop.mustprogress"}
!40 = !DILocation(line: 16, column: 1, scope: !10)
