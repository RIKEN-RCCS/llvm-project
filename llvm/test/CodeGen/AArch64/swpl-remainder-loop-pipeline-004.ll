...
; CHECK-NOT: remark: ./swpl-remainder-loop-pipeline-004.cpp:13:5: software pipelining (IPC: 2.00, ITR: 5, MVE: 3, II: 3, Stage: 3, (VReg Fp: 1/32, Int: 17/29, Pred: 1/8)), SRA(PReg Fp: 0/32, Int: 14/29, Pred: 0/8)
; CHECK: remark: ./swpl-remainder-loop-pipeline-004.cpp:13:5: software pipelining (IPC: 2.00, ITR: 11, MVE: 6, II: 3, Stage: 6, (VReg Fp: 15/32, Int: 17/29, Pred: 2/8)), SRA(PReg Fp: 12/32, Int: 11/29, Pred: 1/8)

; ModuleID = './swpl-remainder-loop-pipeline-004.cpp'
source_filename = "./swpl-remainder-loop-pipeline-004.cpp"
...
!1 = !DIFile(filename: "swpl-remainder-loop-pipeline-004.cpp", directory: "/home/sano", checksumkind: CSK_MD5, checksum: "80c60d4342d68c8b02d6fa23142438a7")
...
!9 = !DIFile(filename: "./swpl-remainder-loop-pipeline-004.cpp", directory: "/home/sano", checksumkind: CSK_MD5, checksum: "80c60d4342d68c8b02d6fa23142438a7")
