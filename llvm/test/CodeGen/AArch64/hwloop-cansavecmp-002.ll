; RUN: llc < %s -mcpu=a64fx -O1 -ffj-swp  -debug-hardwareloops -enable-savecmp  -debug-aarch64tti -o /dev/null 2>&1 | FileCheck %s
; CHECK: return true

; ModuleID = '2901-3-02.c'
source_filename = "2901-3-02.c"
...
!1 = !DIFile(filename: "2901-3-02.c", directory: "2901-3", checksumkind: CSK_MD5, checksum: "8264da515a3589841d8d5d1c45094010")
...
!10 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 3, type: !11, scopeLine: 3, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !12)
!11 = !DISubroutineType(types: !12)
!12 = !{}
!13 = !DILocation(line: 5, column: 18, scope: !10)
