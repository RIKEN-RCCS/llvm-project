; RUN: llc < %s -O2 -mcpu=a64fx -swpl-debug --pass-remarks-analysis=aarch64-swpipeliner -o /dev/null 2>&1 | FileCheck %s
; CHECK: Loop is software pipelined.

; ModuleID = './pragma-loop-pipeline-002.c'
source_filename = "./pragma-loop-pipeline-002.c"
...
!1 = !DIFile(filename: "pragma-loop-pipeline-002.c", directory: "/home/xxxx", checksumkind: CSK_MD5, checksum: "83ae68ffe142d77c777415feb06b72d2")
...
!9 = !DIFile(filename: "./pragma-loop-pipeline-002.c", directory: "/home/xxxx", checksumkind: CSK_MD5, checksum: "83ae68ffe142d77c777415feb06b72d2")
