; RUN: llc < %s -O1 -mcpu=a64fx -fswp -swpl-debug -swpl-minii=8 -swpl-maxii=10 --pass-remarks-filter=aarch64-swpipeliner  -pass-remarks-missed=aarch64-swpipeliner  -o /dev/null 2>&1 | FileCheck %s
