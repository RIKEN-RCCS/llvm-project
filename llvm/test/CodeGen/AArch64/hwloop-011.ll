; RUN: llc < %s -mcpu=a64fx -O1  -ffj-swp  -debug-aarch64tti -debug-hardwareloops --pass-remarks-filter=hardwareloops  -o - 2>&1 | FileCheck %s
; CHECK: HardwareLoopInsertion succeeded
; ModuleID = '2901-2-11.c'
source_filename = "2901-2-11.c"
...
7:                                                ; preds = %10, %2
  %8 = phi double [ 0.000000e+00, %2 ], [ %19, %10 ], !dbg !19
  %9 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str, double noundef %8), !dbg !20
  ret i32 0, !dbg !21
...
10:                                               ; preds = %4, %10
  ...
  %18 = sitofp i32 %17 to double, !dbg !22
  %19 = fadd double %12, %18, !dbg !25
  %20 = add nuw nsw i64 %11, 1, !dbg !26
  %21 = icmp eq i64 %20, %6, !dbg !13
  br i1 %21, label %7, label %10, !dbg !14, !llvm.loop !27
}
...
!1 = !DIFile(filename: "2901-2-11.c", directory: "2901-2", checksumkind: CSK_MD5, checksum: "2c2e08a6b811a49fa68e2c6565079420")
