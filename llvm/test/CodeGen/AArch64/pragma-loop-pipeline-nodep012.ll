...
; CHECK: remark: ./pragma-loop-pipeline-nodep012.cpp:24:1: Since the pragma pipline_nodep was specified, it was assumed that there is no dependency between memory access instructions in the loop.
; CHECK-NOT: remark: ./pragma-loop-pipeline-nodep012.cpp:25:5: software pipelining (IPC: 2.00, ITR: 5, MVE: 3, II: 3, Stage: 3, (VReg Fp: 1/32, Int: 17/29, Pred: 1/8)), SRA(PReg Fp: 0/32, Int: 14/29, Pred: 0/8) 
...
for.end:                                          ; preds = %for.body
  %2 = load i32, ptr %z, align 4, !dbg !30, !tbaa !15
  %call = tail call noundef i32 (ptr, ...) @_Z6printfPKcz(ptr noundef nonnull @.str, i32 noundef %2), !dbg !31
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %z) #3, !dbg !32
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %y) #3, !dbg !32
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %x) #3, !dbg !32
  ret void, !dbg !31
}
...
declare !dbg !33 dso_local noundef i32 @_Z6printfPKcz(ptr noundef, ...) local_unnamed_addr #2
...
!23 = !DILocation(line: 25, column: 25, scope: !8)
!24 = !DILocation(line: 25, column: 19, scope: !8)
!25 = distinct !{!25, !13, !26, !27, !28}
!26 = !DILocation(line: 28, column: 5, scope: !8)
!27 = !{!"llvm.loop.mustprogress"}
!28 = !{!"llvm.loop.unroll.disable"}
!29 = !{!"llvm.loop.pipeline.nodep"}
!30 = !DILocation(line: 29, column: 11, scope: !8)
!31 = !DILocation(line: 30, column: 2, scope: !8)
!32 = !DILocation(line: 31, column: 1, scope: !8)
