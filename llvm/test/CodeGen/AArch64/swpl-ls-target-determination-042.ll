; RUN: llc < %s -O1 -mcpu=a64fx -fls -swpl-max-mem-num=10  --pass-remarks=aarch64-swpipeliner  -pass-remarks-missed=aarch64-swpipeliner  -o /dev/null 2>&1 | FileCheck --allow-empty %s
