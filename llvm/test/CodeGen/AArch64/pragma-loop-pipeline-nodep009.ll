...
; CHECK: remark: ./pragma-loop-pipeline-nodep017.cpp:27:5: Since the pragma pipline_nodep was specified, it was assumed that there is no dependency between memory access instructions in the loop.
