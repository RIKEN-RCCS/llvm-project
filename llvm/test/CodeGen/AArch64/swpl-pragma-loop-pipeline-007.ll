...
; ModuleID = './pragma-loop-pipeline-007.cpp'
source_filename = "./pragma-loop-pipeline-007.cpp"
...
for.body:                                         ; preds = %for.body.preheader11, %for.body
  ...
  %27 = shl i32 %indvars.iv.tr, 1, !dbg !16
  store i32 %27, ptr %arrayidx, align 4, !dbg !16, !tbaa !18
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !15
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count, !dbg !12
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body, !dbg !13, !llvm.loop !31
}
...
!0 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus_14, file: !1, producer: "clang version 15.0.4", isOptimized: true, runtimeVersion: 0, emissionKind: LineTablesOnly, splitDebugInlining: false, nameTableKind: None)
!1 = !DIFile(filename: "pragma-loop-pipeline-007.cpp", directory: "/home/xxxx", checksumkind: CSK_MD5, checksum: "e842b0c32bef3ad1d801362fd8347284")
...
!9 = !DIFile(filename: "./pragma-loop-pipeline-007.cpp", directory: "/home/xxxx", checksumkind: CSK_MD5, checksum: "e842b0c32bef3ad1d801362fd8347284")
...
!21 = !{!"Simple C++ TBAA"}
!22 = distinct !{!22, !13, !23, !24, !25, !26, !29}
!23 = !DILocation(line: 6, column: 3, scope: !8)
!24 = !{!"llvm.loop.mustprogress"}
!25 = !{!"llvm.loop.distribute.enable", i1 true}
!26 = !{!"llvm.loop.distribute.followup_all", !27}
!27 = distinct !{!27, !13, !23, !24, !28}
!28 = !{!"llvm.loop.pipeline.disable", i1 true}
!29 = !{!"llvm.loop.isvectorized", i32 1}
!30 = !DILocation(line: 7, column: 1, scope: !8)
!31 = distinct !{!31, !13, !23, !24, !25, !26, !32, !29}
