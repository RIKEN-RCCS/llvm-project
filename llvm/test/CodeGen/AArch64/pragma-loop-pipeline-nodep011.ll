...
; CHECK: remark: ./pragma-loop-pipeline-nodep012-1.cpp:24:1: Since the pragma pipline_nodep was specified, it was assumed that there is no dependency between memory access instructions in the loop.
...
for.end:                                          ; preds = %for.body
  %2 = load i32, ptr @z, align 4, !dbg !29, !tbaa !14
  %call = tail call noundef i32 (ptr, ...) @_Z6printfPKcz(ptr noundef nonnull @.str, i32 noundef %2), !dbg !30
  ret void, !dbg !31
}

declare !dbg !32 dso_local noundef i32 @_Z6printfPKcz(ptr noundef, ...) local_unnamed_addr #1
...
!13 = !DILocation(line: 27, column: 16, scope: !8)
!14 = !{!15, !15, i64 0}
!15 = !{!"int", !16, i64 0}
!16 = !{!"omnipotent char", !17, i64 0}
!17 = !{!"Simple C++ TBAA"}
!18 = !DILocation(line: 27, column: 23, scope: !8)
!19 = !DILocation(line: 27, column: 21, scope: !8)
!20 = !DILocation(line: 27, column: 9, scope: !8)
!21 = !DILocation(line: 27, column: 14, scope: !8)
!22 = !DILocation(line: 25, column: 25, scope: !8)
!23 = !DILocation(line: 25, column: 19, scope: !8)
!24 = distinct !{!24, !12, !25, !26, !27}
!25 = !DILocation(line: 28, column: 5, scope: !8)
!26 = !{!"llvm.loop.mustprogress"}
!27 = !{!"llvm.loop.unroll.disable"}
!28 = !{!"llvm.loop.pipeline.nodep"}
!29 = !DILocation(line: 29, column: 11, scope: !8)
!30 = !DILocation(line: 30, column: 2, scope: !8)
!31 = !DILocation(line: 31, column: 1, scope: !8)
!32 = !DISubprogram(name: "printf", scope: !9, file: !9, line: 18, type: !10, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
