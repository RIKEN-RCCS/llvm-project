...
; CHECK: remark: target.c:9:3: distributed loop: 3 of 3 hardware-loop not created
; CHECK: remark: target.c:9:3: distributed loop: 1 of 3 hardware-loop not created
; CHECK: remark: target.c:9:3: distributed loop: 2 of 3 hardware-loop not created
; ModuleID = 'target.ll'
