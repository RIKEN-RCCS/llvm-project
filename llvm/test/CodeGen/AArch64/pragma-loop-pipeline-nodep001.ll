...
; CHECK: remark: ./pragma-loop-pipeline-nodep010-1.cpp:27:5: Since the pragma pipeline_nodep was specified, it was assumed that there is no dependency between memory access instructions in the loop.
; CHECK: remark: ./pragma-loop-pipeline-nodep010-1.cpp:27:5: software pipelining 
