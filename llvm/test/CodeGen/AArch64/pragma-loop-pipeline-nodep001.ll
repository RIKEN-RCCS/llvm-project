...
; CHECK: remark: ./pragma-loop-pipeline-nodep010-1.cpp:27:5: Since the pragma pipline_nodep was specified, it was assumed that there is no dependency between memory access instructions in the loop.
; CHECK: remark: ./pragma-loop-pipeline-nodep010-1.cpp:27:5: software pipelining (IPC: 2.00, ITR: 5, MVE: 3, II: 3, Stage: 3, (VReg Fp: 1/32, Int: 17/29, Pred: 1/8)), SRA(PReg Fp: 0/32, Int: 14/29, Pred: 0/8) 
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %47, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !dbg !13, !llvm.loop !30
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, 1000, !dbg !32
  br i1 %exitcond.not, label %for.end, label %for.body, !dbg !12, !llvm.loop !33

for.end:                                          ; preds = %for.body, %vec.epilog.middle.block
  %50 = load i32, ptr @z, align 4, !dbg !34, !tbaa !15
  %call = tail call noundef i32 (ptr, ...) @_Z6printfPKcz(ptr noundef nonnull @.str, i32 noundef %50), !dbg !35
  ret void, !dbg !36
}

declare !dbg !37 dso_local noundef i32 @_Z6printfPKcz(ptr noundef, ...) local_unnamed_addr #1
...
!14 = !DILocation(line: 31, column: 16, scope: !8)
!15 = !{!16, !16, i64 0}
!16 = !{!"int", !17, i64 0}
!17 = !{!"omnipotent char", !18, i64 0}
!18 = !{!"Simple C++ TBAA"}
!19 = !DILocation(line: 31, column: 23, scope: !8)
!20 = !DILocation(line: 31, column: 21, scope: !8)
!21 = !DILocation(line: 31, column: 9, scope: !8)
!22 = !DILocation(line: 31, column: 14, scope: !8)
!23 = distinct !{!23, !12, !24, !25, !26, !27, !28, !29}
...
!30 = distinct !{!30, !12, !24, !25, !26, !27, !28, !29, !31}
!31 = !{!"llvm.remainder.pipeline.disable"}
!32 = !DILocation(line: 27, column: 19, scope: !8)
!33 = distinct !{!33, !12, !24, !25, !26, !27, !29, !31, !28}
!34 = !DILocation(line: 33, column: 11, scope: !8)
!35 = !DILocation(line: 34, column: 2, scope: !8)
!36 = !DILocation(line: 35, column: 1, scope: !8)
!37 = !DISubprogram(name: "printf", scope: !9, file: !9, line: 18, type: !10, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
