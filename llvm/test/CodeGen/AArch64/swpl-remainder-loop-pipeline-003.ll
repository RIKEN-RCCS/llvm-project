...
; CHECK: remark: ./swpl-remainder-loop-pipeline-003.cpp:13:5: software pipelining (IPC: 2.00, ITR: 5, MVE: 3, II: 3, Stage: 3
; CHECK: remark: ./swpl-remainder-loop-pipeline-003.cpp:13:5: software pipelining (IPC: 2.00, ITR: 11, MVE: 6, II: 3, Stage: 6

; ModuleID = './swpl-remainder-loop-pipeline-003.cpp'
source_filename = "./swpl-remainder-loop-pipeline-003.cpp"
