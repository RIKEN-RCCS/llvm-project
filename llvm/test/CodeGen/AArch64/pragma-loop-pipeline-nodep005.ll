...
; CHECK: remark: ./pragma-loop-pipeline-nodep012-1.cpp:25:5: Since the pragma pipeline_nodep was specified, it was assumed that there is no dependency between memory access instructions in the loop.
; CHECK: remark: ./pragma-loop-pipeline-nodep012-1.cpp:25:5: software pipelining 
