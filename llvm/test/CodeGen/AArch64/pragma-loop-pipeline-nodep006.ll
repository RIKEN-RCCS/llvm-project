...
; CHECK: remark: ./pragma-loop-pipeline-nodep012.cpp:25:5: Since the pragma pipline_nodep was specified, it was assumed that there is no dependency between memory access instructions in the loop.
