...
; CHECK: remark: ./pragma-loop-pipeline-nodep011.cpp:25:1: Since the pragma pipline_nodep was specified, it was assumed that there is no dependency between memory access instructions in the loop.
; CHECK-NOT: remark: ./pragma-loop-pipeline-nodep011.cpp:26:5: software pipelining (IPC: 2.00, ITR: 5, MVE: 3, II: 3, Stage: 3, (VReg Fp: 1/32, Int: 17/29, Pred: 1/8)), SRA(PReg Fp: 0/32, Int: 14/29, Pred: 0/8) 

; ModuleID = './pragma-loop-pipeline-nodep011.cpp'
source_filename = "./pragma-loop-pipeline-nodep011.cpp"
...
!1 = !DIFile(filename: "pragma-loop-pipeline-nodep011.cpp", directory: "/home/xxxx", checksumkind: CSK_MD5, checksum: "b8f87f23453ac1b4bba20e5d5bd9cc7b")
...
!9 = !DIFile(filename: "./pragma-loop-pipeline-nodep011.cpp", directory: "/home/matsunami/dev/llvm-project", checksumkind: CSK_MD5, checksum: "b8f87f23453ac1b4bba20e5d5bd9cc7b")
...
!29 = !{!"llvm.loop.pipeline.disable", i1 true}
