...
bool Parser::HandlePragmaLoopHint(LoopHint &Hint) {
  ...
  bool OptionDistribute4swp = false;
  ...
  if (OptionInfo) { // Pragma Unroll does not specify an option.
    ...
    OptionDistribute4swp = OptionInfo->isStr("distribute4swp");
    StateOption = llvm::StringSwitch<bool>(OptionInfo->getName())
                  ...
                  OptionPipelineDisabled || OptionPipelineNodep || OptionDistribute4swp;
  }

  bool AssumeSafetyArg = !OptionUnroll && !OptionUnrollAndJam &&
                         !OptionDistribute && !OptionPipelineDisabled && !OptionPipelineNodep && !OptionDistribute4swp;
