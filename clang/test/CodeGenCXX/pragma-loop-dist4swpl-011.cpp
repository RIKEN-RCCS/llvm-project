...
// CHECK-NEXT: [[DIST_3]] = distinct !{[[DIST_3]], [[MP]], [[VEC_2:![0-9]+]], [[UR:![0-9]+]], [[UR_FA:![0-9]+]]}
// CHECK-NEXT: [[VEC_2]] = !{!"llvm.loop.isvectorized"}
// CHECK-NEXT: [[UR]] = !{!"llvm.loop.unroll.enable"}
// CHECK-NEXT: [[UR_FA]] = !{!"llvm.loop.unroll.followup_all", [[DIST_4:![0-9]+]]}
// CHECK-NEXT: [[DIST_4]] = distinct !{[[DIST_4]], [[MP]], [[VEC_2]], [[UR_2:![0-9]+]], [[PIP:![0-9]+]]}
