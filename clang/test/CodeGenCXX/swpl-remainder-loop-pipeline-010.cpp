// RUN: %clang_cc1 -triple aarch64-unknown-hurd-gnu -emit-llvm -target-cpu a64fx -Ofast -vectorize-loops -fno-unroll-loops -mllvm -swpl-enable-pipeline-remainder-unroll -o - %s | FileCheck %s
...
// CHECK: ![[LOOP1]] = distinct !{![[LOOP1]], [[DIS:![0-9]+]]}
