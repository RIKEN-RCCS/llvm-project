...
// CHECK: ![[LOOP1_1]] = distinct !{![[LOOP1_1]], [[MP:![0-9]+]], [[UR:![0-9]+]], [[D4SWPL:![0-9]+]], [[D4SWPLF:![0-9]+]], [[D4SWPLI:![0-9]+]], [[D4SWPL_FA:![0-9]+]]}
...
// CHECK-NEXT: [[D4SWPLI]] = !{!"llvm.loop.distribute4swpl.ireg", i32 999}
// CHECK-NEXT: [[D4SWPL_FA]] = !{!"llvm.loop.distribute4swpl.followup_all", [[DIST_1:![0-9]+]]}
// CHECK-NEXT: [[DIST_1]] = distinct !{[[DIST_1]], [[MP]], [[UR]], [[DIST:![0-9]+]], [[PIP:![0-9]+]]}
// CHECK-NEXT: [[DIST]] = !{!"llvm.loop.distribute.enable", i1 false}
