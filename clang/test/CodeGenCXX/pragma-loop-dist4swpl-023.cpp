...
#define H_1 "clang loop distribute4swpl_limit_inst(1)"
#define H_2 "clang loop distribute4swpl_limit_inst(0)"
#define H_3 "clang loop distribute4swpl_limit_inst()"
#define H_4 "clang loop distribute4swpl_limit_inst(enable)"
...
// CHECK: ![[LOOP1_1]] = distinct !{![[LOOP1_1]], [[MP:![0-9]+]], [[D4SWPL:![0-9]+]], [[D4SWPLF:![0-9]+]], [[D4SWPLINST:![0-9]+]], [[D4SWPL_FA:![0-9]+]]}
...
// CHECK-NEXT: [[D4SWPLINST]] = !{!"llvm.loop.distribute4swpl.inst", i32 1}
// CHECK-NEXT: [[D4SWPL_FA]] = !{!"llvm.loop.distribute4swpl.followup_all", [[DIST_1:![0-9]+]]}
// CHECK-NEXT: [[DIST_1]] = distinct !{[[DIST_1]], [[MP]], [[VEC:![0-9]+]], [[VEC_FA:![0-9]+]]}
// CHECK-NEXT: [[VEC]] = !{!"llvm.loop.vectorize.enable", i1 true}
// CHECK-NEXT: [[VEC_FA]] = !{!"llvm.loop.vectorize.followup_all", [[DIST_2:![0-9]+]]}
// CHECK-NEXT: [[DIST_2]] = distinct !{[[DIST_2]], [[MP]], [[VEC_2:![0-9]+]], [[UR:![0-9]+]], [[UR_FA:![0-9]+]]}
// CHECK-NEXT: [[VEC_2]] = !{!"llvm.loop.isvectorized"}
// CHECK-NEXT: [[UR]] = !{!"llvm.loop.unroll.enable"}
// CHECK-NEXT: [[UR_FA]] = !{!"llvm.loop.unroll.followup_all", [[DIST_3:![0-9]+]]}
// CHECK-NEXT: [[DIST_3]] = distinct !{[[DIST_3]], [[MP]], [[VEC_2]], [[UR_2:![0-9]+]], [[PIP:![0-9]+]]}
// CHECK-NEXT: [[UR_2]] = !{!"llvm.loop.unroll.disable"}
